...
<html lang="en">
  <head>
    ...
    <title>UBT University-News</title>
      ...
      <div class="default_archive">
        ...
        <div class="block_section other_items">
          <div class="container">
            <div class="row">
              <div
                class="section_articles post_container post_container--flexible_content post_container--three-columns inf-scroll"
              >
                <div class="post_item">
